      ...
      <Card className="col-span-12 md:col-span-3 border-none shadow-none bg-transparent p-0">
        ...
        <div className="space-y-3">
          {[
            ...
            <div
              key={idx}
              className="flex items-center justify-between bg-white p-3 rounded-2xl border border-slate-100"
            >
              <div className="flex items-center gap-3">
                <div
                  className={`w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-sm ${item.color} font-bold`}
                >
                  {item.icon}
                </div>
      ...
      <Card className="col-span-12 md:col-span-4 bg-slate-100 border-none relative overflow-hidden">
        ...
        <div className="h-48 mt-8 flex items-end justify-between px-4 gap-4">
          ...
          <div className="w-12 bg-pink-100 rounded-t-xl h-[60%] relative group">
            <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white shadow-sm p-1 rounded-full text-pink-500">
              🏀
            </div>
          </div>
          <div className="w-12 bg-white rounded-t-xl h-[40%] relative">
            <div className="absolute top-2 left-1/2 -translate-x-1/2 text-slate-300 font-bold text-xs">
              Be
            </div>
          </div>
          <div className="w-12 bg-white rounded-t-xl h-[30%] relative">
            <div className="absolute top-2 left-1/2 -translate-x-1/2 text-red-400 font-bold text-xs">
              G
            </div>
          </div>
      ...
      <Card className="col-span-12 md:col-span-5 bg-white border-none shadow-sm">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-2 hover:bg-slate-50 rounded-xl transition-colors group">
            <div className="flex items-center gap-2 w-1/4 min-w-0 overflow-hidden">
              <Avatar
                size="sm"
            ...
            <span className="text-xs font-bold text-slate-700 w-1/5 truncate">
              $209,633
            </span>
            <div className="flex items-center gap-2 w-1/6 flex-shrink-0">
              <span className="w-6 h-6 rounded-full bg-black text-white flex items-center justify-center text-[10px] font-bold flex-shrink-0">
                41
              </span>
              <span className="text-xs text-slate-400">118</span>
            </div>
            <span className="text-xs font-medium text-slate-500 w-1/6 truncate">
              0.84
            </span>
            <div className="flex items-center gap-2 w-1/6 justify-end flex-shrink-0">
              <span className="text-xs text-slate-500">31%</span>
              <span className="w-6 h-6 rounded-full bg-slate-900 text-white flex items-center justify-center text-[10px] font-bold flex-shrink-0">
                12
              </span>
          ...
          <div className="flex items-center justify-between p-2 hover:bg-slate-50 rounded-xl transition-colors group">
            ...
            <div className="flex items-center gap-2 w-1/6 flex-shrink-0">
              <span className="w-6 h-6 rounded-full bg-slate-800 text-white flex items-center justify-center text-[10px] font-bold flex-shrink-0">
                54
              </span>
        ...
        <div className="flex gap-2 mt-6 overflow-x-auto pb-2 scrollbar-hide">
          {["Top sales 💪", "Sales streak 🔥", "Top review 👍"].map(
            (tag, i) => (
              <span
                key={i}
                className="px-3 py-1 bg-slate-50 rounded-full text-[10px] font-semibold text-slate-600 whitespace-nowrap border border-slate-100"
              >
                {tag}
              </span>
            )
